...
public class thursday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new details("09:50","10:40","Data Structure and Its Applications"));
        arrayList.add(new details("10:45","11:35","Data Structure and Its Applications"));
        arrayList.add(new details("11:40","12:30","-"));
        ...
        ListView listView = findViewById(R.id.thursdayListView);
